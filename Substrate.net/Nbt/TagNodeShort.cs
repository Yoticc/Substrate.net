...
public sealed class TagNodeShort : TagNode
{
    ...
    public static implicit operator TagNodeShort(byte b) => new(b);
    ...
    /// <returns>A new short node containing the given value.</returns>
    public static implicit operator TagNodeShort(short s) => new(s);
    ...
    public static implicit operator short(TagNodeShort s) => s.Data;
    ...
    public static implicit operator int(TagNodeShort s) => s.Data;
    ...
    public static implicit operator long(TagNodeShort s) => s.Data;
}