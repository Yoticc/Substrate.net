...
public sealed class TagNodeByte : TagNode
{
    ...
    public static implicit operator TagNodeByte(byte b) => new(b);
    ...
    public static implicit operator byte(TagNodeByte b) => b.Data;
    ...
    public static implicit operator short(TagNodeByte b) => b.Data;
    ...
    public static implicit operator int(TagNodeByte b) => b.Data;
    ...
    public static implicit operator long(TagNodeByte b) => b.Data;
}