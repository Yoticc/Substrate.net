...
public class NbtTree : ICopyable<NbtTree>
{
    ...
    private static TagNodeNull _nulltag = new();

    /// <summary>
    /// Gets the root node of this tree.
    /// </summary>
    public TagNodeCompound Root { get; private set; } = null;
    ...
    private TagNode ReadByte()
    {
        ...
        TagNodeByte val = new((byte)gzByte);
    ...
    private TagNode ReadShort()
    {
        ...
        TagNodeShort val = new(BitConverter.ToInt16(gzBytes, 0));
    ...
    private TagNode ReadInt()
    {
        ...
        TagNodeInt val = new(BitConverter.ToInt32(gzBytes, 0));
    ...
    private TagNode ReadLong()
    {
        ...
        TagNodeLong val = new(BitConverter.ToInt64(gzBytes, 0));
    ...
    private TagNode ReadFloat()
    {
        ...
        TagNodeFloat val = new(BitConverter.ToSingle(gzBytes, 0));
    ...
    private TagNode ReadDouble()
    {
        ...
        TagNodeDouble val = new(BitConverter.ToDouble(gzBytes, 0));
    ...
    private TagNode ReadString()
    {
        ...
        TagNodeString val = new(str.GetString(strBytes));
    ...
    private TagNode ReadList()
    {
        ...
        TagNodeList val = new((TagType)gzByte);
    ...
    private TagNode ReadShortArray()
    {
        ...
        TagNodeShortArray val = new(data);
