...
public sealed class TagNodeFloat : TagNode
{
    ...
    public static implicit operator TagNodeFloat(float f) => new(f);
    ...
    public static implicit operator float(TagNodeFloat f) => f.Data;
    ...
    public static implicit operator double(TagNodeFloat f) => f.Data;
}