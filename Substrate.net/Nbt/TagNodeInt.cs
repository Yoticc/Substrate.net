...
public sealed class TagNodeInt : TagNode
{
    ...
    public static implicit operator TagNodeInt(byte b) => new(b);
    ...
    /// <returns>A new int node containing the given value.</returns>
    public static implicit operator TagNodeInt(short s) => new(s);
    ...
    /// <returns>A new int node containing the given value.</returns>
    public static implicit operator TagNodeInt(int i) => new(i);
    ...
    public static implicit operator int(TagNodeInt i) => i.Data;
    ...
    public static implicit operator long(TagNodeInt i) => i.Data;
}