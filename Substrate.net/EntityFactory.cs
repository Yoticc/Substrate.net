...
public class EntityFactory
{
    ...
    {
        Type t;
        return !_registry.TryGetValue(type, out t) ? null : Activator.CreateInstance(t) as TypedEntity;
    }
    ...
    public static TypedEntity CreateGeneric(TagNodeCompound tree)
    {
        ...
        TypedEntity te = new(type.ToTagString().Data);
    ...
    {
        Type t;
        return !_registry.TryGetValue(type, out t) ? null : t;
    }
