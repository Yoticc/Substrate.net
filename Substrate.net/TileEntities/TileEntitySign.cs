...
public class TileEntitySign : TileEntity
{
    ...
    {
        get => _text1;
        set => _text1 = value.Length > 14 ? value[..14] : value;
    }

    public string Text2
    {
        get => _text2;
        set => _text2 = value.Length > 14 ? value[..14] : value;
    }

    public string Text3
    {
        get => _text3;
        set => _text3 = value.Length > 14 ? value[..14] : value;
    }

    public string Text4
    {
        get => _text4;
        set => _text4 = value.Length > 14 ? value[..14] : value;
    }
