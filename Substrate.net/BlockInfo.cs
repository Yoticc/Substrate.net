...
public class BlockInfo
{
    ...
    public bool TransmitsLight { get; private set; } = false;
    ...
    /// </summary>
    public bool Registered { get; } = false;
    ...
    public BlockInfo SetOpacity(int opacity)
    {
        ...
        TransmitsLight = opacity != MAX_OPACITY;
    ...
    public BlockInfo SetState(BlockState state)
    {
        ...
        BlocksFluid = State == BlockState.SOLID;
    ...
    {
        return _dataLimits == null || _dataLimits.Test(data);
    }
