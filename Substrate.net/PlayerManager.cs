...
public class PlayerManager : IPlayerManager, IEnumerable<Player>
{
    ...
    public NbtTree GetPlayerTree(string name)
    {
        ...
        return nbtstr == null ? throw new NbtIOException("Failed to initialize NBT data stream for input.") : new NbtTree(nbtstr);
    }
    ...
    public Player GetPlayer(string name)
    {
        ...
        {
            PlayerIOException pex = new("Could not load player", ex);
    ...
    public void SetPlayer(string name, Player player)
    {
        ...
        {
            PlayerIOException pex = new("Could not save player", ex);
            pex.Data["PlayerName"] = name;
            throw pex;
        }
    }
    ...
    public void DeletePlayer(string name)
    {
        ...
        {
            PlayerIOException pex = new("Could not remove player", ex);
            pex.Data["PlayerName"] = name;
            throw pex;
        }
    }
    ...
    private class Enumerator : IEnumerator<Player>
    {
        ...
        public Player Current => _curPlayer ?? throw new InvalidOperationException();
        ...
        protected static Regex _namePattern = new(".+\\.dat$");
    }
}
