...
public class MapManager : IMapManager, IEnumerable<Map>
{
    ...
    public Map GetMap(int id)
    {
        ...
        {
            DataIOException pex = new("Could not load map", ex);
            pex.Data["MapId"] = id;
            throw pex;
        }
    }
    ...
    public void SetMap(int id, Map map)
    {
        ...
        {
            DataIOException pex = new("Could not save map", ex);
            pex.Data["MapId"] = id;
            throw pex;
        }
    }
    ...
    public void DeleteMap(int id)
    {
        ...
        {
            DataIOException pex = new("Could not remove map", ex);
            pex.Data["MapId"] = id;
            throw pex;
        }
    }
    ...
    private static Regex _namePattern = new("^map_[0-9]+\\.dat$");
}
